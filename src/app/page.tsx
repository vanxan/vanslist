...
function SectionHeader({ title, icon: Icon, actionLabel, actionHref }: {
  ...
  return (
    <div className="flex justify-between items-center mb-6 mt-16 sm:mt-[100px]">
      <h2 className="text-lg sm:text-xl font-bold text-[#1a1a1a] flex items-center gap-2">
        <Icon size={22} className="text-gold" />
        {title}
      </h2>
      {actionLabel && actionHref && (
        <Link href={actionHref} className="bg-white border border-gray-200 rounded-lg px-3 sm:px-4 py-1.5 text-xs text-gray-500 flex items-center gap-1 hover:border-gray-300 transition-colors whitespace-nowrap">
...
export default function HomePage() {
  ...
  return (
    <div className="max-w-container mx-auto px-4 sm:px-6">
      ...
      {/* Hero */}
      <div className="text-center pt-10 sm:pt-16 pb-10">
        ...
        <RotatingHero />
        <p className="text-sm sm:text-base text-gray-400 max-w-xl mx-auto mb-7 leading-relaxed mt-6 sm:mt-[42px]">
          AI tools, prompts, and workflows for small businesses.
          <br />Reviewed in plain English. No tech degree required.
        </p>
        <div className="max-w-lg mx-auto mb-8 relative px-2 sm:px-0">
          <svg className="absolute left-6 sm:left-4 top-1/2 -translate-y-1/2 text-gray-300" width="18" height="18" viewBox="0 0 256 256" fill="currentColor"><path d="M229.66,218.34l-50.07-50.07a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.31ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"/></svg>
          <input
        ...
        <div className="flex gap-2 justify-center flex-wrap">
          {[
            ...
            <span key={t.label} className={`inline-flex items-center gap-1.5 rounded-full px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs font-semibold border transition-colors ${
          ...
          <Link href="/browse" className="inline-flex items-center gap-1 bg-white text-gray-400 border border-gray-200 rounded-full px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs font-semibold hover:border-gray-300 transition-colors">
      ...
      {/* CTA */}
      <div className="mt-16 sm:mt-20 mb-16 text-center">
        <h2 className="text-xl sm:text-2xl font-bold mb-2">Questions?</h2>
